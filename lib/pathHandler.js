    ...
    requestedUserPromise.then((requestedUser) => {
        if (!requestedUser) {
            dbHandler.addUser({
                ...
                phone: '',
                email: '',
                avatar: 'https://w7.pngwing.com/pngs/831/88/png-transparent-user-profile-computer-icons-user-interface-mystique-miscellaneous-user-interface-design-smile.png',
                city: '',
                gender: '',
                state: '',
                msgList: [],
